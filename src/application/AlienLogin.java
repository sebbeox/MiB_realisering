...
public class AlienLogin extends javax.swing.JFrame  {
    ...
    private void initComponents() {
        ...
        alienDLbl = new javax.swing.JLabel();
        ...
        alienDLbl.setForeground(new java.awt.Color(0, 0, 0));
        alienDLbl.setText("AlienID:");
                ...
                .addGroup(loginPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(loginPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(loginPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(alienDLbl))
                        .addGap(58, 58, 58)
                        .addGroup(loginPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(alienID, javax.swing.GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE)
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        boolean found = false;
        try {
            Integer.parseInt(alienID.getText());
        }
        catch (NumberFormatException undantag){
            JOptionPane.showMessageDialog(null, "Ett giltigt AlienID består av endast heltal!");
            alienID.requestFocus();
        }
        try {
            int antalAgenter = Integer.parseInt(db.fetchSingle("SELECT COUNT(*) FROM ALIEN"));
            for (int i = 0; i <= antalAgenter; i++){
                if (Integer.parseInt(alienID.getText()) == Integer.parseInt(db.fetchSingle("SELECT " + i + " FROM ALIEN"))){
                    found = true;
                    break;
                }
            }
            if (!found) {
                JOptionPane.showMessageDialog(null, "Ogiltigt AlienID!");
            }
            if (found && new String(lösenord.getPassword()).equals(db.fetchSingle("SELECT LOSENORD FROM ALIEN WHERE ALIEN_ID = " + alienID.getText()))){
                
                    new AlienPortal(db, alienID.getText()).setVisible(true);
                    AlienLogin.this.dispose();
            }
            else{
    ...
    private javax.swing.JLabel alienDLbl;
